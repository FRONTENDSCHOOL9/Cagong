...
# 서비스 소개 ☕️
**카공여지도**는 공부하기 좋은 카페를 추천해주는 서비스예요. 최근 카페는 단순히 커피를 마시는 것을 넘어, 공부와 업무를 위한 공간으로 이용되는 경우가 많아지고 있어요. 카공여지도는 이러한 카페 이용 문화의 변화에 주목해 공부와 업무에 최적화된 카페를 추천해요.
